...
<BlogHeader title="Three essential steps to detect customer happiness" date="2024/06/29" description="In this blog post, we'll explore the cause of this problem and provide a step-by-step guide to fix it." authorid="jayvanzyl" ogImage="/images/blog/2024-06-29-customer-feedback.jpg" />
