...
<div>
  <Cards num={2}>
    ...
    <Cards.Card title="" href="/docs/quick_start/marketplace" icon={<CustomEndpoints />} image />
  </Cards>
</div>
...
<Cards num={6}>
  ...
  <Cards.Card href="/docs/marketplace" title="Marketplace Apps" image arrow>
  ...
  <Cards.Card href="/docs/modules" title="Modules" image arrow>
...
<div>
  <Cards num={3}>
    ...
    <Cards.Card title="" href="/blog/2025-07-03_2026_roadmap" icon={<Roadmap />} image />
    <Cards.Card title="" href="/docs/workers" icon={<ToolKit />} image />
