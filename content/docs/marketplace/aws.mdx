...
description: Setup ecosystem.Ai Platform in AWS
---

# Guide to Setting up ecosystem.Ai Platform in AWS

<Cards>
    <Cards.Card href="https://aws.amazon.com/marketplace/pp/prodview-kr3eipc3hphes" title="Platform Option" arrow>
        ![image](/images/install/aws-platform-vm.png)
    </Cards.Card>
    <Cards.Card href="https://aws.amazon.com/marketplace/pp/prodview-2kak2xwqqgd3w" title="Spend Personality Option" arrow>
        ![image](/images/install/aws-platform-personality.png)
    </Cards.Card>
</Cards>
