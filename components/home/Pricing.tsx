...
const faqs = [
  {
    question: 'What is the ecosystem.Ai Admin Panel?',
    answer:
      'The ecosystem.Ai Admin Panel is a powerful tool designed to provide administrators with extensive control and management capabilities over their ecosystem.Ai instance. It allows you to configure roles, manage users, access advanced analytics, and more.',
  },
  {
    question: 'How can I access the Admin Panel?',
    answer:
      'To access the ecosystem.Ai Admin Panel, you will need to subscribe to the paid plan that includes access to this feature. Once subscribed, you will receive credentials and instructions on how to access and utilize the Admin Panel.',
  },
  {
    question: 'What features are available in the Admin Panel?',
    answer:
      'The Admin Panel offers features such as role-based access control, project configurations, user management with real-time data, analytics, integration with external tools, and more. It serves as a comprehensive tool for managing your ecosystem.Ai environment efficiently.',
  },
  {
    question: 'Is the Admin Panel included in the free plan?',
    answer:
      'No, the Admin Panel is a premium feature available with paid subscriptions. The free plan of ecosystem.Ai includes core functionalities but does not grant access to the advanced capabilities offered by the Admin Panel.',
  },
  {
